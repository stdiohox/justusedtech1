...
export default function NotFound() {
  return (
    <section className="flex min-h-[60dvh] items-center bg-paper py-24">
      <div className="shell">
        ...
        <p className="mt-5 max-w-[48ch] text-[1.0625rem] leading-relaxed text-ink-soft">
          The page you were looking for has moved or never existed. The links
          below cover most of what people come here for.
        </p>
